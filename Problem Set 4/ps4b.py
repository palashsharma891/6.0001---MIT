...
# Name: <your name here>
# Collaborators:
# Time Spent: x:xx - (12:21 - 16:43) on 11-05-2020
...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(26):
            if i + shift <= 25:
                shift_dict[LOWER_LETTERS[i]] = LOWER_LETTERS[i + shift]
                shift_dict[UPPER_LETTERS[i]] = UPPER_LETTERS[i + shift]
            else:
                shift_dict[LOWER_LETTERS[i]] = LOWER_LETTERS[i + shift - 26]
                shift_dict[UPPER_LETTERS[i]] = UPPER_LETTERS[i + shift - 26]
    ...
    def apply_shift(self, shift):
        ...
        for char in word:
            if char in LOWER_LETTERS or char in UPPER_LETTERS:
                new_word = new_word + shifted_dict[char]
            else:
